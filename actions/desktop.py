...
def organize_desktop(mode: str = "by_type") -> str:
    ...
    for item in desktop.iterdir():
        ...
        try:
            ...
            skipped.append(f"{item.name} (Error: {e})")
...
def desktop_control(
    ...
    try:
        if action == "wallpaper":
            ...
            if "organize" in actual_task.lower() or "organise" in actual_task.lower():
                return organize_desktop("by_date" if "date" in actual_task.lower() else "by_type")
            if "clean" in actual_task.lower() and "desktop" in actual_task.lower():
                return clean_desktop()
            ...
            if action:
                if "organize" in action.lower() or "organise" in action.lower():
